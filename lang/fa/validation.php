...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'village_code' => 'کد روستا',
        'division_information_id' => 'شناسه تقسیم بندی اطلاعات',
        'national_id' => 'شناسه ملی دهیاری',
        'area_hectares' => 'وسعت منطقه',
        'category' => 'دسته بندی',
        'registration_plate' => 'پلاک ثبتی',
        'machine_basic_id' => 'شناسه اطاعات اولیه ماشین',
        'plate_type' => 'نوع پلاک',
        'delivery_date' => 'تاریخ تحویل',
        'fuel' => 'نوع سوخت',
        'number_axles' => 'تعداد محور',
        'capacity' => 'ضرفیت',
        'number_cylinders' => 'تعداد سیلندر',
        'chassis_number' => 'شناسه شاسی',
        'manufacturing_year' => 'سال تولید',
        'engine_number' => 'شماره موتور',
        'system' => 'سیستم حرکتی',
        'amount' => 'مقدار',
        'funding_source' => 'محل تمین بودجه',
        'status_report_date' => 'تاریخ اعلام وضعیت',
        'status' => 'وضعیت',
        'function' => 'کارکرد',
        'gps' => 'ردیاب GPS',
        'duration' => 'مدت',
        'region_supervisor' => 'بخشدار مربوطه',
        'reason' => 'دلیل',
        'attachment_file' => 'فایل پیوست',
        'attachment' => 'فایل پیوست',
        'work_end_date' => 'تاریخ پایان کار',
        'user.nid' => 'کدملی کاربر',
        'user.first_name' => 'نام کاربر',
        'user.last_name' => 'نام خوانوادگی کاربر',
        'contract_id' => 'شناسه قرارداد',
        'work_group' => 'نقش (گروه کاری)',
